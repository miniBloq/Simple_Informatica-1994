...
{Rutinas para controlar la interfaz:}
   procedure Inicializar(PortID :SmallInt); stdcall;
   procedure ApagaTodo; stdcall;
   procedure EscribeMotor(MotorID :SmallInt; Accion :SmallInt); stdcall;
   procedure EscribeSalida(ReleID, Accion :SmallInt); stdcall;
   function LeeMotor(MotorID :SmallInt) :SmallInt; stdcall;
   function LeeSalida(ReleID :SmallInt) :WordBool;stdcall;
   function LeeSensor(SenID :SmallInt) :WordBool; stdcall;

{Rutinas de bajo nivel:}
   procedure out(ID, Val: SmallInt); stdcall;
   function inp(ID: SmallInt): SmallInt; stdcall;
